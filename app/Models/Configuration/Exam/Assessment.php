...
class Assessment extends Model
{
    ...
    protected $table = 'exam_assessments';

    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->useLogName('exam_assessment')
            ->logAll()
    ...
    {
        return $this->hasMany('App\Models\Configuration\Exam\AssessmentDetail', 'exam_assessment_id');
    }

    public function schedules()
    {
        return $this->hasMany('App\Models\Exam\Schedule', 'exam_assessment_id');
    }
